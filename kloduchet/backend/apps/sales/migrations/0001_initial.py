    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("sales_doc_date", models.DateField(blank=True, null=True)),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="sales_saler_organiz_f7b657_idx",
                    ),
                    models.Index(
                        fields=["organization", "nomenclature"],
                        name="sales_saler_organiz_472a68_idx",
                    ),
                    models.Index(
                        fields=["organization", "legal_entity"],
                        name="sales_saler_organiz_8c68f6_idx",
                    ),
                    models.Index(
                        fields=["organization", "contract_number"],
                        name="sales_saler_organiz_4ad008_idx",
                    ),
                ],
            },
        ),
